...
class GrievanceCreate(BaseModel):
    model_config = ConfigDict(populate_by_name=True, extra='allow')  # Allow 'grievance_details' alias
    
    # ID is auto-generated by backend - clients should not provide it
    # Removed: id field
    ...
    def convert_empty_strings_to_none(cls, data: Any) -> Any:
        ...
        Also rejects client-provided 'id' field for security.
        """
        if isinstance(data, dict):
            # Reject client-provided ID field (enforce server-side ID generation)
            if 'id' in data:
                raise ValueError("ID field is not allowed - IDs are generated server-side")
